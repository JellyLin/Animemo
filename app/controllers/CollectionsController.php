...
class CollectionsController extends ControllerBase
{
	...
	$products = Products::find("product_types_id=16");
        $this->view->setVar("animeNames", $products);
        $this->view->setVar("animeCounts", count($products));
    }
    ...
    public function searchAction()
    {
        ...
        if (count($products) == 0) {
            ...
            return $this->forward("collections/index");
        }
    ...
    public function createAction()
    {
        ...
        if (!$products->save()) {
            ...
            return $this->forward("collections/new");
    ...
    public function saveAction()
    {
        ...
        if (!$products->save()) {
            ...
            return $this->forward("collections/edit/" . $products->id);
        } else {
    ...
    public function deleteAction($id)
    {
        ...
        if (!$products->delete()) {
            ...
            return $this->forward("collections/search");
        } else {
